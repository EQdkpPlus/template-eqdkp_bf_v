<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="font-size: 13px;font-family: Tahoma, Arial, Verdana, sans-serif;color: #000;padding: 0;margin: 0;height: 100%">
		<div id="header" style="padding: 15px 30px; background: #121212;">
		...
		<div id="main" style="overflow: auto;margin: 0 auto; padding: 15px 30px;">
				<div id="content" style="background-color: #FFF;padding: 20px;">
					<h1 style="font-family: &quot;Trebuchet MS&quot;, Arial, sans-serif;font-weight: bold;padding-bottom: 5px;border-bottom: 1px solid #CCC;margin: 5px 0 10px 0;font-size: 20px;color:#f88613">{SUBJECT}</h1>
					{CONTENT}
				</div>
		</div>
		
		<div id="footer" style="margin-top: 1em; font-size: 12px; background-color: #121212; color: #fff; padding: 15px 30px;">
			{SIGNATURE}
			<br /><br />
